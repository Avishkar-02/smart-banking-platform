package com.smartbanking.accountservice.exception;
...
public class GlobalExceptionHandler {
    ...
    // Handles all our custom BusinessExceptions from service layer
    ...
    // Handles @NotBlank failures on @RequestHeader parameters.
    // ConstraintViolationException is thrown when @Validated class-level
    // annotation catches violations on method parameters (headers, path vars).
    ...
    // When X-User-Uuid header is completely absent from the request,
    // Spring throws MissingRequestHeaderException before our code runs.
