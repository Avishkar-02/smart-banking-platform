...
public enum ErrorCode {
    ...
    KYC_NOT_APPROVED("KYC approval required before this action"),
    ...
    // This is the idempotency collision — same key, same result returned
    ...
    // The human-readable message that goes into ApiResponse.message
